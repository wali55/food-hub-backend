...
*/
-- AlterTable
ALTER TABLE "Order" ALTER COLUMN "deliveryType" SET DEFAULT 'COD';
...
-- AddForeignKey
ALTER TABLE "User" ADD CONSTRAINT "User_id_fkey" FOREIGN KEY ("id") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE;
